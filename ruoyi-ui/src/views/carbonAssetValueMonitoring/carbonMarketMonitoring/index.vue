<template>
  <div class="kline-chart-container">
      ...
      <el-col :span="4">
        <el-card class="stat-card">
          <div class="stat-content">
            <div>
              <span>开盘：</span>
              <b class="highlight-blue">89.90</b>
            </div>
            <div>
              <span>收盘：</span>
              <b>90.13</b>
    ...
    <el-card class="chart-card">
      <div ref="kChart" style="height: 500px;"></div>
    </el-card>
  </div>
</template>
  ...
  methods: {
    ...
    initKLineChart() {
      const data0 = this.splitData([
        ...
        ['2024/2/1', 2377.41, 2419.02, 2369.57, 2421.15],
        ...
        ['2024/2/22', 2322.94, 2314.16, 2308.76, 2330.88],
        ['2024/2/25', 2320.62, 2325.82, 2315.01, 2338.78],
        ['2024/2/26', 2313.74, 2293.34, 2289.89, 2340.71],
        ['2024/2/27', 2297.77, 2313.22, 2292.03, 2324.63],
        ['2024/2/28', 2322.32, 2365.59, 2308.92, 2366.16],
        ...
        ['2024/3/7', 2340.44, 2324.29, 2304.27, 2352.02],
        ['2024/3/8', 2326.42, 2318.61, 2314.59, 2333.67],
        ['2024/3/11', 2314.68, 2310.59, 2296.58, 2320.96],
        ['2024/3/12', 2309.16, 2286.6, 2264.83, 2333.29],
        ['2024/3/13', 2282.17, 2263.97, 2253.25, 2286.33],
        ['2024/3/14', 2255.77, 2270.28, 2253.31, 2276.22],
        ['2024/3/15', 2269.31, 2278.4, 2250, 2312.08],
      ...
      const chartDom = this.$refs.kChart;
      ...
      const option = {
        ...
        series: [
          ...
          },
          {
            ...
            smooth: true,
            lineStyle: { opacity: 0.5, color: "#FF4500" },
          },
        ],
      };
